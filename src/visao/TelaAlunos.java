...
public class TelaAlunos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButtonMatricular = new javax.swing.JToggleButton();
        jToggleButtonCancelarMat = new javax.swing.JToggleButton();
        ...
        jToggleButtonMatricular.setText("Matricular");
        jToggleButtonMatricular.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jToggleButtonMatricularActionPerformed(evt);
            }
        });
        getContentPane().add(jToggleButtonMatricular);
        jToggleButtonMatricular.setBounds(340, 125, 110, 80);

        jToggleButtonCancelarMat.setText("Cancelar Matricula");
        getContentPane().add(jToggleButtonCancelarMat);
        jToggleButtonCancelarMat.setBounds(60, 215, 110, 80);
...
TelaAlunoCadastro tela = new TelaAlunoCadastro();
...
dispose();
    ...
    private void jToggleButtonPesqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonPesqActionPerformed
        TelaAlunoPesq tela = new TelaAlunoPesq();
        tela.setVisible(true);
    ...
    private void jToggleButtonMatricularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonMatricularActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButtonMatricularActionPerformed
    ...
    private javax.swing.JToggleButton jToggleButtonCancelarMat;
    private javax.swing.JToggleButton jToggleButtonMatricular;
